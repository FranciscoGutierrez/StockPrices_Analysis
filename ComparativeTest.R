...
s2.e.act.int   <- conf.interval(normalize.with(s2.series.boxplot.easy$ls.actions    ,c(ls.s2.easy.actions, ls.s2.medi.actions, ls.s2.hard.actions) )) - s2.mean.actions
s2.e.act.det   <- conf.interval(normalize.with(s2.charts.boxplot.easy$ls.actions    ,c(ls.s2.easy.actions, ls.s2.medi.actions, ls.s2.hard.actions) )) - s2.mean.actions
s2.e.act.com   <- conf.interval(normalize.with(s2.dots.boxplot.easy$ls.actions      ,c(ls.s2.easy.actions, ls.s2.medi.actions, ls.s2.hard.actions) )) - s2.mean.actions
s2.m.act.int   <- conf.interval(normalize.with(s2.series.boxplot.medium$ls.actions  ,c(ls.s2.easy.actions, ls.s2.medi.actions, ls.s2.hard.actions) )) - s2.mean.actions
s2.m.act.det   <- conf.interval(normalize.with(s2.charts.boxplot.medium$ls.actions  ,c(ls.s2.easy.actions, ls.s2.medi.actions, ls.s2.hard.actions) )) - s2.mean.actions
s2.m.act.com   <- conf.interval(normalize.with(s2.dots.boxplot.medium$ls.actions    ,c(ls.s2.easy.actions, ls.s2.medi.actions, ls.s2.hard.actions) )) - s2.mean.actions
s2.h.act.int   <- conf.interval(normalize.with(s2.series.boxplot.hard$ls.actions    ,c(ls.s2.easy.actions, ls.s2.medi.actions, ls.s2.hard.actions) )) - s2.mean.actions
s2.h.act.det   <- conf.interval(normalize.with(s2.charts.boxplot.hard$ls.actions    ,c(ls.s2.easy.actions, ls.s2.medi.actions, ls.s2.hard.actions) )) - s2.mean.actions
s2.h.act.com   <- conf.interval(normalize.with(s2.dots.boxplot.hard$ls.actions      ,c(ls.s2.easy.actions, ls.s2.medi.actions, ls.s2.hard.actions) )) - s2.mean.actions
s2.e.speed.int <- conf.interval(normalize.with(s2.series.boxplot.easy$ls.speed      ,c(ls.s2.easy.speed, ls.s2.medi.speed, ls.s2.hard.speed)       )) - s2.mean.speed
s2.e.speed.det <- conf.interval(normalize.with(s2.charts.boxplot.easy$ls.speed      ,c(ls.s2.easy.speed, ls.s2.medi.speed, ls.s2.hard.speed)       )) - s2.mean.speed
s2.e.speed.com <- conf.interval(normalize.with(s2.dots.boxplot.easy$ls.speed        ,c(ls.s2.easy.speed, ls.s2.medi.speed, ls.s2.hard.speed)       )) - s2.mean.speed
s2.m.speed.int <- conf.interval(normalize.with(s2.series.boxplot.medium$ls.speed    ,c(ls.s2.easy.speed, ls.s2.medi.speed, ls.s2.hard.speed)       )) - s2.mean.speed
s2.m.speed.det <- conf.interval(normalize.with(s2.charts.boxplot.medium$ls.speed    ,c(ls.s2.easy.speed, ls.s2.medi.speed, ls.s2.hard.speed)       )) - s2.mean.speed
s2.m.speed.com <- conf.interval(normalize.with(s2.dots.boxplot.medium$ls.speed      ,c(ls.s2.easy.speed, ls.s2.medi.speed, ls.s2.hard.speed)       )) - s2.mean.speed
s2.h.speed.int <- conf.interval(normalize.with(s2.series.boxplot.hard$ls.speed      ,c(ls.s2.easy.speed, ls.s2.medi.speed, ls.s2.hard.speed)       )) - s2.mean.speed
s2.h.speed.det <- conf.interval(normalize.with(s2.charts.boxplot.hard$ls.speed      ,c(ls.s2.easy.speed, ls.s2.medi.speed, ls.s2.hard.speed)       )) - s2.mean.speed
s2.h.speed.com <- conf.interval(normalize.with(s2.dots.boxplot.hard$ls.speed        ,c(ls.s2.easy.speed, ls.s2.medi.speed, ls.s2.hard.speed)       )) - s2.mean.speed
...
s1.e.act.int   <- conf.interval(normalize.with(s1.series.boxplot.easy$ls.actions    ,c(ls.s1.easy.actions, ls.s1.medi.actions, ls.s1.hard.actions) )) - s1.mean.actions
s1.e.act.det   <- conf.interval(normalize.with(s1.charts.boxplot.easy$ls.actions    ,c(ls.s1.easy.actions, ls.s1.medi.actions, ls.s1.hard.actions) )) - s1.mean.actions
s1.e.act.com   <- conf.interval(normalize.with(s1.dots.boxplot.easy$ls.actions      ,c(ls.s1.easy.actions, ls.s1.medi.actions, ls.s1.hard.actions) )) - s1.mean.actions
s1.m.act.int   <- conf.interval(normalize.with(s1.series.boxplot.medium$ls.actions  ,c(ls.s1.easy.actions, ls.s1.medi.actions, ls.s1.hard.actions) )) - s1.mean.actions
s1.m.act.det   <- conf.interval(normalize.with(s1.charts.boxplot.medium$ls.actions  ,c(ls.s1.easy.actions, ls.s1.medi.actions, ls.s1.hard.actions) )) - s1.mean.actions
s1.m.act.com   <- conf.interval(normalize.with(s1.dots.boxplot.medium$ls.actions    ,c(ls.s1.easy.actions, ls.s1.medi.actions, ls.s1.hard.actions) )) - s1.mean.actions
s1.h.act.int   <- conf.interval(normalize.with(s1.series.boxplot.hard$ls.actions    ,c(ls.s1.easy.actions, ls.s1.medi.actions, ls.s1.hard.actions) )) - s1.mean.actions
s1.h.act.det   <- conf.interval(normalize.with(s1.charts.boxplot.hard$ls.actions    ,c(ls.s1.easy.actions, ls.s1.medi.actions, ls.s1.hard.actions) )) - s1.mean.actions
s1.h.act.com   <- conf.interval(normalize.with(s1.dots.boxplot.hard$ls.actions      ,c(ls.s1.easy.actions, ls.s1.medi.actions, ls.s1.hard.actions) )) - s1.mean.actions
s1.e.speed.int <- conf.interval(normalize.with(s1.series.boxplot.easy$ls.speed      ,c(ls.s1.easy.speed, ls.s1.medi.speed, ls.s1.hard.speed)       )) - s1.mean.speed
s1.e.speed.det <- conf.interval(normalize.with(s1.charts.boxplot.easy$ls.speed      ,c(ls.s1.easy.speed, ls.s1.medi.speed, ls.s1.hard.speed)       )) - s1.mean.speed
s1.e.speed.com <- conf.interval(normalize.with(s1.dots.boxplot.easy$ls.speed        ,c(ls.s1.easy.speed, ls.s1.medi.speed, ls.s1.hard.speed)       )) - s1.mean.speed
s1.m.speed.int <- conf.interval(normalize.with(s1.series.boxplot.medium$ls.speed    ,c(ls.s1.easy.speed, ls.s1.medi.speed, ls.s1.hard.speed)       )) - s1.mean.speed
s1.m.speed.det <- conf.interval(normalize.with(s1.charts.boxplot.medium$ls.speed    ,c(ls.s1.easy.speed, ls.s1.medi.speed, ls.s1.hard.speed)       )) - s1.mean.speed
s1.m.speed.com <- conf.interval(normalize.with(s1.dots.boxplot.medium$ls.speed      ,c(ls.s1.easy.speed, ls.s1.medi.speed, ls.s1.hard.speed)       )) - s1.mean.speed
s1.h.speed.int <- conf.interval(normalize.with(s1.series.boxplot.hard$ls.speed      ,c(ls.s1.easy.speed, ls.s1.medi.speed, ls.s1.hard.speed)       )) - s1.mean.speed
s1.h.speed.det <- conf.interval(normalize.with(s1.charts.boxplot.hard$ls.speed      ,c(ls.s1.easy.speed, ls.s1.medi.speed, ls.s1.hard.speed)       )) - s1.mean.speed
s1.h.speed.com <- conf.interval(normalize.with(s1.dots.boxplot.hard$ls.speed        ,c(ls.s1.easy.speed, ls.s1.medi.speed, ls.s1.hard.speed)       )) - s1.mean.speed
...
ggplot(s1.e.acc.int, aes(x = "Intuitive", y = mean)) + 
    ...
    geom_pointrange(data = s1.e.acc.det, aes(x="Detailed" ,y = 0.13, ymax = 0.20, ymin = 0.06), size=1, color = "#DB2F2E") + 
...
#  s2.h.speed.com$min))
 ...
 s1.acc.max    <- c(s1.e.acc.int$max, 0.2, s1.e.acc.com$max, s1.m.acc.int$max, s1.m.acc.det$max, s1.m.acc.com$max, s1.h.acc.int$max, s1.h.acc.det$max, s1.h.acc.com$max)
