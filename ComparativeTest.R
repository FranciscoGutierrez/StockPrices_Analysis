...
s1.series.boxplot.easy   <- data.frame(subset(s1.accuracy, difficulty=="easy"   & viz=="map",   select=accuracy), subset(s1.actions,  difficulty=="easy"   & viz=="map",   select=actions), subset(s1.speed, difficulty=="easy"   & viz=="map",   select=speed))
s1.charts.boxplot.easy   <- data.frame(subset(s1.accuracy, difficulty=="easy"   & viz=="chart", select=accuracy), subset(s1.actions,  difficulty=="easy"   & viz=="chart", select=actions), subset(s1.speed, difficulty=="easy"   & viz=="chart", select=speed))
s1.dots.boxplot.easy     <- data.frame(subset(s1.accuracy, difficulty=="easy"   & viz=="dots",  select=accuracy), subset(s1.actions,  difficulty=="easy"   & viz=="dots",  select=actions), subset(s1.speed, difficulty=="easy"   & viz=="dots",  select=speed))
s1.series.boxplot.medium <- data.frame(subset(s1.accuracy, difficulty=="medium" & viz=="map",   select=accuracy), subset(s1.actions,  difficulty=="medium" & viz=="map",   select=actions), subset(s1.speed, difficulty=="medium" & viz=="map",   select=speed))
s1.charts.boxplot.medium <- data.frame(subset(s1.accuracy, difficulty=="medium" & viz=="chart", select=accuracy), subset(s1.actions,  difficulty=="medium" & viz=="chart", select=actions), subset(s1.speed, difficulty=="medium" & viz=="chart", select=speed))
s1.dots.boxplot.medium   <- data.frame(subset(s1.accuracy, difficulty=="medium" & viz=="dots",  select=accuracy), subset(s1.actions,  difficulty=="medium" & viz=="dots",  select=actions), subset(s1.speed, difficulty=="medium" & viz=="dots",  select=speed))
s1.series.boxplot.hard   <- data.frame(subset(s1.accuracy, difficulty=="hard"   & viz=="map",   select=accuracy), subset(s1.actions,  difficulty=="hard"   & viz=="map",   select=actions), subset(s1.speed, difficulty=="hard"   & viz=="map",   select=speed))
s1.charts.boxplot.hard   <- data.frame(subset(s1.accuracy, difficulty=="hard"   & viz=="chart", select=accuracy), subset(s1.actions,  difficulty=="hard"   & viz=="chart", select=actions), subset(s1.speed, difficulty=="hard"   & viz=="chart", select=speed))
s1.dots.boxplot.hard     <- data.frame(subset(s1.accuracy, difficulty=="hard"   & viz=="dots",  select=accuracy), subset(s1.actions,  difficulty=="hard"   & viz=="dots",  select=actions), subset(s1.speed, difficulty=="hard"   & viz=="dots",  select=speed))

s2.series.boxplot.easy   <- data.frame(subset(s2.accuracy, difficulty=="easy"   & viz=="series", select=accuracy), subset(s2.actions,  difficulty=="easy"   & viz=="series", select=actions), subset(s2.speed, difficulty=="easy"   & viz=="series", select=speed))
s2.charts.boxplot.easy   <- data.frame(subset(s2.accuracy, difficulty=="easy"   & viz=="chart",  select=accuracy), subset(s2.actions,  difficulty=="easy"   & viz=="chart",  select=actions), subset(s2.speed, difficulty=="easy"   & viz=="chart",  select=speed))
s2.dots.boxplot.easy     <- data.frame(subset(s2.accuracy, difficulty=="easy"   & viz=="dots",   select=accuracy), subset(s2.actions,  difficulty=="easy"   & viz=="dots",   select=actions), subset(s2.speed, difficulty=="easy"   & viz=="dots",   select=speed))
s2.series.boxplot.medium <- data.frame(subset(s2.accuracy, difficulty=="medium" & viz=="series", select=accuracy), subset(s2.actions,  difficulty=="medium" & viz=="series", select=actions), subset(s2.speed, difficulty=="medium" & viz=="series", select=speed))
s2.charts.boxplot.medium <- data.frame(subset(s2.accuracy, difficulty=="medium" & viz=="chart",  select=accuracy), subset(s2.actions,  difficulty=="medium" & viz=="chart",  select=actions), subset(s2.speed, difficulty=="medium" & viz=="chart",  select=speed))
s2.dots.boxplot.medium   <- data.frame(subset(s2.accuracy, difficulty=="medium" & viz=="dots",   select=accuracy), subset(s2.actions,  difficulty=="medium" & viz=="dots",   select=actions), subset(s2.speed, difficulty=="medium" & viz=="dots",   select=speed))
s2.series.boxplot.hard   <- data.frame(subset(s2.accuracy, difficulty=="hard"   & viz=="series", select=accuracy), subset(s2.actions,  difficulty=="hard"   & viz=="series", select=actions), subset(s2.speed, difficulty=="hard"   & viz=="series", select=speed))
s2.charts.boxplot.hard   <- data.frame(subset(s2.accuracy, difficulty=="hard"   & viz=="chart",  select=accuracy), subset(s2.actions,  difficulty=="hard"   & viz=="chart",  select=actions), subset(s2.speed, difficulty=="hard"   & viz=="chart",  select=speed))
s2.dots.boxplot.hard     <- data.frame(subset(s2.accuracy, difficulty=="hard"   & viz=="dots",   select=accuracy), subset(s2.actions,  difficulty=="hard"   & viz=="dots",   select=actions), subset(s2.speed, difficulty=="hard"   & viz=="dots",   select=speed))

# #### First Study
# s1.series.boxplot.easy   <- read.csv("data/data_viz/s1.series.boxplot.easy.csv"  )
# s1.charts.boxplot.easy   <- read.csv("data/data_viz/s1.charts.boxplot.easy.csv"  )
# s1.dots.boxplot.easy     <- read.csv("data/data_viz/s1.dots.boxplot.easy.csv"    )
# s1.series.boxplot.medium <- read.csv("data/data_viz/s1.series.boxplot.medium.csv")
# s1.charts.boxplot.medium <- read.csv("data/data_viz/s1.charts.boxplot.medium.csv")
# s1.dots.boxplot.medium   <- read.csv("data/data_viz/s1.dots.boxplot.medium.csv"  )
# s1.series.boxplot.hard   <- read.csv("data/data_viz/s1.series.boxplot.hard.csv"  )
# s1.charts.boxplot.hard   <- read.csv("data/data_viz/s1.charts.boxplot.hard.csv"  )
# s1.dots.boxplot.hard     <- read.csv("data/data_viz/s1.dots.boxplot.hard.csv"    )
# 
# #### Second Study
# s2.series.boxplot.easy   <- read.csv("data/data_viz/s2.series.boxplot.easy.csv"  )
# s2.charts.boxplot.easy   <- read.csv("data/data_viz/s2.charts.boxplot.easy.csv"  )
# s2.dots.boxplot.easy     <- read.csv("data/data_viz/s2.dots.boxplot.easy.csv"    )
# s2.series.boxplot.medium <- read.csv("data/data_viz/s2.series.boxplot.medium.csv")
# s2.charts.boxplot.medium <- read.csv("data/data_viz/s2.charts.boxplot.medium.csv")
# s2.dots.boxplot.medium   <- read.csv("data/data_viz/s2.dots.boxplot.medium.csv"  )
# s2.series.boxplot.hard   <- read.csv("data/data_viz/s2.series.boxplot.hard.csv"  )
# s2.charts.boxplot.hard   <- read.csv("data/data_viz/s2.charts.boxplot.hard.csv"  )
# s2.dots.boxplot.hard     <- read.csv("data/data_viz/s2.dots.boxplot.hard.csv"    )

colnames(s1.series.boxplot.easy  ) <- c("ls.accuracy","ls.actions","ls.speed")
colnames(s1.charts.boxplot.easy  ) <- c("ls.accuracy","ls.actions","ls.speed")
colnames(s1.dots.boxplot.easy    ) <- c("ls.accuracy","ls.actions","ls.speed")
colnames(s1.series.boxplot.medium) <- c("ls.accuracy","ls.actions","ls.speed")
colnames(s1.charts.boxplot.medium) <- c("ls.accuracy","ls.actions","ls.speed")
colnames(s1.dots.boxplot.medium  ) <- c("ls.accuracy","ls.actions","ls.speed")
colnames(s1.series.boxplot.hard  ) <- c("ls.accuracy","ls.actions","ls.speed")
colnames(s1.charts.boxplot.hard  ) <- c("ls.accuracy","ls.actions","ls.speed")
colnames(s1.dots.boxplot.hard    ) <- c("ls.accuracy","ls.actions","ls.speed")
colnames(s2.series.boxplot.easy  ) <- c("ls.accuracy","ls.actions","ls.speed")
colnames(s2.charts.boxplot.easy  ) <- c("ls.accuracy","ls.actions","ls.speed")
colnames(s2.dots.boxplot.easy    ) <- c("ls.accuracy","ls.actions","ls.speed")
colnames(s2.series.boxplot.medium) <- c("ls.accuracy","ls.actions","ls.speed")
colnames(s2.charts.boxplot.medium) <- c("ls.accuracy","ls.actions","ls.speed")
colnames(s2.dots.boxplot.medium  ) <- c("ls.accuracy","ls.actions","ls.speed")
colnames(s2.series.boxplot.hard  ) <- c("ls.accuracy","ls.actions","ls.speed")
colnames(s2.charts.boxplot.hard  ) <- c("ls.accuracy","ls.actions","ls.speed")
colnames(s2.dots.boxplot.hard    ) <- c("ls.accuracy","ls.actions","ls.speed")
...
s1.mean.acc            <- mean(c(ls.s1.easy.accuracy, ls.s1.medi.accuracy, ls.s1.hard.accuracy))
...
s1.mean.speed          <- mean(normalize(c(ls.s1.easy.speed, ls.s1.medi.speed, ls.s1.hard.speed)))
...
s1.mean.actions        <- mean(normalize(c(ls.s1.easy.actions, ls.s1.medi.actions, ls.s1.hard.actions)))
...
s2.mean.acc            <- mean(c(ls.s2.easy.accuracy, ls.s2.medi.accuracy, ls.s2.hard.accuracy))
...
s2.mean.speed          <- mean(normalize(c(ls.s2.easy.speed, ls.s2.medi.speed, ls.s2.hard.speed)))
...
s2.mean.actions        <- mean(normalize(c(ls.s2.easy.actions, ls.s2.medi.actions, ls.s2.hard.actions)))
...
ggplot(data=s1.acc.df, aes(x=factor(s1.acc.df$ind, levels = c("s1.acc.easy", "s1.acc.medium", "s1.acc.hard")), y=values, group=s1.acc.viz, color=s1.acc.viz)) +
    ...
    geom_point(aes(shape=s1.acc.viz), size=3, position=position_dodge(0.3)) +
...
ggplot(data=s2.acc.df, aes(x=factor(s2.acc.df$ind, levels = c("s2.acc.easy", "s2.acc.medium", "s2.acc.hard")), y=values, group=s2.acc.viz, color=s2.acc.viz)) +
    ...
    geom_line(size = 1.1, position=position_dodge(0.3)) + 
    geom_point(aes(shape=s2.acc.viz), size=3, position=position_dodge(0.3))+
    scale_y_continuous(limits = c(-0.2,0.2)) +
...
ggplot(data=s1.act.df, aes(x=factor(s1.act.df$ind, levels = c("s1.act.easy", "s1.act.medium", "s1.act.hard")), y=values, group=s1.act.viz, color=s1.act.viz)) +
    ...
    geom_line(size = 1.1, position=position_dodge(0.3)) + 
    geom_point(aes(shape=s1.act.viz), size=3, position=position_dodge(0.3))+
    scale_y_continuous(limits = c(-0.2,0.2)) +
    scale_color_brewer(palette="Reds", type="qual") +
    theme_void() +
    theme(legend.position="none")
...
ggplot(data=s2.act.df, aes(x=factor(s2.act.df$ind, levels = c("s2.act.easy", "s2.act.medium", "s2.act.hard")), y=values, group=s2.act.viz, color=s2.act.viz)) +
    ...
    geom_line(size = 1.1, position=position_dodge(0.3)) + 
    geom_point(aes(shape=s2.act.viz), size=3, position=position_dodge(0.3))+
    scale_y_continuous(limits = c(-0.2,0.2)) +
    scale_color_brewer(palette="Blues", type="qual") +
    theme_void() +
    theme(legend.position="none")
...
ggplot(data=s1.speed.df, aes(x=factor(s1.speed.df$ind, levels = c("s1.speed.easy", "s1.speed.medium", "s1.speed.hard")), y=values, group=s1.speed.viz, color=s1.speed.viz)) +
    ...
    geom_line(size = 1.1, position=position_dodge(0.3)) + 
    geom_point(aes(shape=s1.speed.viz), size=3, position=position_dodge(0.3))+
    scale_y_continuous(limits = c(-0.2,0.2)) +
    scale_color_brewer(palette="Reds", type="qual") +
    theme_void() +
    theme(legend.position="none")
...
ggplot(data=s2.speed.df, aes(x=factor(s2.speed.df$ind, levels = c("s2.speed.easy", "s2.speed.medium", "s2.speed.hard")), y=values, group=s2.speed.viz, color=s2.speed.viz)) +
    ...
    geom_line(size = 1.1, position=position_dodge(0.3)) + 
    geom_point(aes(shape=s2.speed.viz), size=3, position=position_dodge(0.3))+
    scale_y_continuous(limits = c(-0.2,0.2)) +
    scale_color_brewer(palette="Blues", type="qual") +
    theme_void() +
    theme(legend.position="none")
