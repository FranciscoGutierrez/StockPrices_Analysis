...
t.test(subset(s2.accuracy, difficulty=="easy"   & viz=="dots",   select=accuracy))
t.test(subset(s2.accuracy, difficulty=="easy"   & viz=="chart",  select=accuracy))
t.test(subset(s2.accuracy, difficulty=="easy"   & viz=="series", select=accuracy))
t.test(subset(s2.accuracy, difficulty=="medium" & viz=="series", select=accuracy))
t.test(subset(s2.accuracy, difficulty=="medium" & viz=="dots",   select=accuracy))
t.test(subset(s2.accuracy, difficulty=="medium" & viz=="chart",  select=accuracy))
t.test(subset(s2.accuracy, difficulty=="hard"   & viz=="chart",  select=accuracy))
t.test(subset(s2.accuracy, difficulty=="hard"   & viz=="dots",   select=accuracy))
t.test(subset(s2.accuracy, difficulty=="hard"   & viz=="series", select=accuracy))
...
t.test(subset(s2.actions, difficulty=="easy"   & viz=="dots",   select=actions))
t.test(subset(s2.actions, difficulty=="easy"   & viz=="series", select=actions))
t.test(subset(s2.actions, difficulty=="easy"   & viz=="chart",  select=actions))
t.test(subset(s2.actions, difficulty=="medium" & viz=="dots",   select=actions))
t.test(subset(s2.actions, difficulty=="medium" & viz=="chart",  select=actions))
t.test(subset(s2.actions, difficulty=="medium" & viz=="series", select=actions))
t.test(subset(s2.actions, difficulty=="hard"   & viz=="chart",  select=actions))
t.test(subset(s2.actions, difficulty=="hard"   & viz=="dots",   select=actions))
t.test(subset(s2.actions, difficulty=="hard"   & viz=="series", select=actions))
...
t.test(subset(s2.speed, difficulty=="easy"   & viz=="dots",   select=speed))
t.test(subset(s2.speed, difficulty=="easy"   & viz=="series", select=speed))
t.test(subset(s2.speed, difficulty=="easy"   & viz=="chart",  select=speed))
t.test(subset(s2.speed, difficulty=="medium" & viz=="chart",  select=speed))
t.test(subset(s2.speed, difficulty=="medium" & viz=="dots",   select=speed))
t.test(subset(s2.speed, difficulty=="medium" & viz=="series", select=speed))
t.test(subset(s2.speed, difficulty=="hard"   & viz=="chart",  select=speed))
t.test(subset(s2.speed, difficulty=="hard"   & viz=="series", select=speed))
t.test(subset(s2.speed, difficulty=="hard"   & viz=="dots",   select=speed))
...
ggplot(t1.time.e.int, aes(x = c("intuitive","detailed", "comptime"), y = mean)) + 
...
ggplot(t1.time.m.int, aes(x = c("intuitive","detailed", "comptime"), y = mean)) + 
    geom_pointrange(data = t1.time.m.int, aes(x="Intuitive",y = mean, ymax = max, ymin = min), size=1, color = "#08519c") + 
    geom_pointrange(data = t1.time.m.det, aes(x="Detailed" ,y = mean, ymax = max, ymin = min), size=1, color = "#08519c") + 
...
ggplot(t1.time.h.int, aes(x = c("intuitive","detailed", "comptime"), y = mean)) + 
