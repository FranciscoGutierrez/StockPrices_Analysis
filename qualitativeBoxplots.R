...
rcorr(as.matrix(subset(s1.all,             select = c(ls.speed, ls.actions, ls.accuracy,  ease, appeal, expect, trust, confidence, credible))), type="spearman") 
rcorr(as.matrix(subset(s1.intuitive,       select = c(ls.speed, ls.actions, ls.accuracy,  ease, appeal, expect, trust, confidence, credible))), type="spearman") 
rcorr(as.matrix(subset(s1.detailed,        select = c(ls.speed, ls.actions, ls.accuracy,  ease, appeal, expect, trust, confidence, credible))), type="spearman") 
rcorr(as.matrix(subset(s1.compact,         select = c(ls.speed, ls.actions, ls.accuracy,  ease, appeal, expect, trust, confidence, credible))), type="spearman") 
rcorr(as.matrix(subset(s1.intuitive.easy,  select = c(ls.speed, ls.actions, ls.accuracy,  ease, appeal, expect, trust, confidence, credible))), type="spearman") 
rcorr(as.matrix(subset(s1.intuitive.medium,select = c(ls.speed, ls.actions, ls.accuracy,  ease, appeal, expect, trust, confidence, credible))), type="spearman") 
rcorr(as.matrix(subset(s1.intuitive.hard,  select = c(ls.speed, ls.actions, ls.accuracy,  ease, appeal, expect, trust, confidence, credible))), type="spearman") 
rcorr(as.matrix(subset(s1.detailed.easy,   select = c(ls.speed, ls.actions, ls.accuracy,  ease, appeal, expect, trust, confidence, credible))), type="spearman") 
rcorr(as.matrix(subset(s1.detailed.medium, select = c(ls.speed, ls.actions, ls.accuracy,  ease, appeal, expect, trust, confidence, credible))), type="spearman") 
rcorr(as.matrix(subset(s1.detailed.hard,   select = c(ls.speed, ls.actions, ls.accuracy,  ease, appeal, expect, trust, confidence, credible))), type="spearman") 
rcorr(as.matrix(subset(s1.compact.easy,    select = c(ls.speed, ls.actions, ls.accuracy,  ease, appeal, expect, trust, confidence, credible))), type="spearman") 
rcorr(as.matrix(subset(s1.compact.medium,  select = c(ls.speed, ls.actions, ls.accuracy,  ease, appeal, expect, trust, confidence, credible))), type="spearman") 
rcorr(as.matrix(subset(s1.compact.hard,    select = c(ls.speed, ls.actions, ls.accuracy,  ease, appeal, expect, trust, confidence, credible))), type="spearman") 
