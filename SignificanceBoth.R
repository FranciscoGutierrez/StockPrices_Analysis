...
#### First Study
s1.study.dots   <- read.csv("data/old/s1_dots.csv")
s1.study.charts <- read.csv("data/old/s1_charts.csv")
s1.study.series <- read.csv("data/old/s1_maps.csv")
s1.qf.charts    <- read.csv("data/old/qf1_charts.csv")
s1.qf.dots      <- read.csv("data/old/qf1_dots.csv")
s1.qf.series    <- read.csv("data/old/qf1_maps.csv")

#### Second Study
s2.study.dots   <- read.csv("data/old/s2_dots.csv")
s2.study.charts <- read.csv("data/old/s2_charts.csv")
s2.study.series <- read.csv("data/old/s2_series.csv")
s2.qf.charts    <- read.csv("data/old/qf2_charts.csv")
s2.qf.dots      <- read.csv("data/old/qf2_dots.csv")
s2.qf.series    <- read.csv("data/old/qf2_series.csv")
...
# write.csv(s1.df.accuracy.all, file = "s1.df.accuracy.all.csv")
# write.csv(s1.df.actions.all,  file = "s1.df.actions.all.csv")
# write.csv(s1.df.speed.all,    file = "s1.df.speed.all.csv")
# write.csv(s2.df.accuracy.all, file = "s2.df.accuracy.all.csv")
# write.csv(s2.df.actions.all,  file = "s2.df.actions.all.csv")
# write.csv(s2.df.speed.all,    file = "s2.df.speed.all.csv")

write.csv(s1.charts.boxplot.easy,   file = "s1.charts.boxplot.easy.csv") 
write.csv(s1.series.boxplot.easy,   file = "s1.series.boxplot.easy.csv")
write.csv(s1.dots.boxplot.easy,     file = "s1.dots.boxplot.easy.csv")    
write.csv(s1.series.boxplot.medium, file = "s1.series.boxplot.medium.csv") 
write.csv(s1.charts.boxplot.medium, file = "s1.charts.boxplot.medium.csv")
write.csv(s1.dots.boxplot.medium,   file = "s1.dots.boxplot.medium.csv")
write.csv(s1.charts.boxplot.hard,   file = "s1.charts.boxplot.hard.csv")
write.csv(s1.series.boxplot.hard,   file = "s1.series.boxplot.hard.csv") 
write.csv(s1.dots.boxplot.hard,     file = "s1.dots.boxplot.hard.csv")
...
s1.df.accuracy.all <- rbind(head(s1.df.accuracy.easy,211), s1.df.accuracy.medium, head(s1.df.accuracy.hard,211))
s1.df.actions.all  <- rbind(head(s1.df.actions.easy, 211), s1.df.actions.medium,  head(s1.df.actions.hard, 211))
s1.df.speed.all    <- rbind(head(s1.df.speed.easy,   211), s1.df.speed.medium,    head(s1.df.speed.hard,   211))

s2.df.accuracy.all <- rbind(s2.df.accuracy.easy, head(s2.df.accuracy.medium, 266), s2.df.accuracy.hard)
s2.df.actions.all  <- rbind(s2.df.actions.easy,  head(s2.df.actions.medium,  266), s2.df.actions.hard)
s2.df.speed.all    <- rbind(s2.df.speed.easy,    head(s2.df.speed.medium,    266), s2.df.speed.hard)
